...
public class AccountC_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaKH = new Eternel_restaurants.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenKH = new javax.swing.JLabel();
        txttenKH = new Eternel_restaurants.View.Swing.MyTextField();
        lbngayTG = new javax.swing.JLabel();
        lbdso = new javax.swing.JLabel();
        txtdso = new Eternel_restaurants.View.Swing.MyTextField();
        lbdTL = new javax.swing.JLabel();
        txtdiemtl = new Eternel_restaurants.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        txtngayTG = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/profile65.png"))); // NOI18N

        lbmaKH.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lbmaKH.setForeground(new java.awt.Color(37, 161, 142));
        lbmaKH.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbmaKH.setText("Mã Khách hàng");

        txtmaKH.setEditable(false);
        txtmaKH.setBackground(new java.awt.Color(173, 216, 230));
        txtmaKH.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbtenKH.setForeground(new java.awt.Color(37, 161, 142));
        lbtenKH.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbtenKH.setText("Tên Khách Hàng");

        txttenKH.setForeground(new java.awt.Color(37, 161, 142));
        txttenKH.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbngayTG.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbdso.setForeground(new java.awt.Color(37, 161, 142));
        lbdso.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbdso.setText("Doanh số");

        txtdso.setEditable(false);
        txtdso.setBackground(new java.awt.Color(173, 216, 230));
        txtdso.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbdTL.setForeground(new java.awt.Color(37, 161, 142));
        lbdTL.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbdTL.setText("Điểm tích lũy");

        txtdiemtl.setEditable(false);
        txtdiemtl.setBackground(new java.awt.Color(173, 216, 230));
        txtdiemtl.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtngayTG.setBackground(new java.awt.Color(173, 216, 230));
        txtngayTG.setForeground(new java.awt.Color(37, 161, 142));
        txtngayTG.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtngayTG.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
    ...
    private Eternel_restaurants.View.Swing.MyTextField txtdiemtl;
    private Eternel_restaurants.View.Swing.MyTextField txtdso;
    private Eternel_restaurants.View.Swing.MyTextField txtemail;
    private Eternel_restaurants.View.Swing.MyTextField txtmaKH;
    private Eternel_restaurants.View.Swing.MyPasswordField txtmatkhau;
    private Eternel_restaurants.View.Swing.MyTextField txtngayTG;
    private Eternel_restaurants.View.Swing.MyTextField txtrole;
    private Eternel_restaurants.View.Swing.MyTextField txttenKH;
