package Eternel_restaurants.View.Form.Staff_Form;

import Eternel_restaurants.Controller.Service.ServiceStaff;
import Eternel_restaurants.Model.ModelNhanVien;
import Eternel_restaurants.Model.ModelNguoiDung;
import Eternel_restaurants.View.Dialog.MS_ChangePassword;
import Eternel_restaurants.View.Dialog.MS_ConfirmRename;
import Eternel_restaurants.View.Main_Frame.Main_Staff_Frame;
...
public class AccountS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        bg = new Eternel_restaurants.View.Swing.PanelRound();
        pic = new Eternel_restaurants.View.Swing.ImageAvatar();
        lbmaNV = new javax.swing.JLabel();
        txtngVL = new Eternel_restaurants.View.Swing.MyTextField();
        titleKH = new javax.swing.JLabel();
        lbtenNV = new javax.swing.JLabel();
        txttenNV = new Eternel_restaurants.View.Swing.MyTextField();
        lbngVL = new javax.swing.JLabel();
        lbCvu = new javax.swing.JLabel();
        txtCvu = new Eternel_restaurants.View.Swing.MyTextField();
        lbNQL = new javax.swing.JLabel();
        txtMaNQL = new Eternel_restaurants.View.Swing.MyTextField();
        titleND = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbEmail = new javax.swing.JLabel();
        txtemail = new Eternel_restaurants.View.Swing.MyTextField();
        lbmk = new javax.swing.JLabel();
        txtmatkhau = new Eternel_restaurants.View.Swing.MyPasswordField();
        jSeparator2 = new javax.swing.JSeparator();
        cmdDMK = new Eternel_restaurants.View.Swing.Button();
        lbRole = new javax.swing.JLabel();
        txtrole = new Eternel_restaurants.View.Swing.MyTextField();
        txtSDT = new Eternel_restaurants.View.Swing.MyTextField();
        lbSDT = new javax.swing.JLabel();
        txtmaNV = new Eternel_restaurants.View.Swing.MyTextField();

        setBackground(new java.awt.Color(240, 240, 240));

        bg.setBackground(new java.awt.Color(247, 247, 247));

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/parkbogum.png"))); // NOI18N

        lbmaNV.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lbmaNV.setForeground(new java.awt.Color(37, 161, 142));
        lbmaNV.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbmaNV.setText("Mã Nhân Viên");

        txtngVL.setEditable(false);
        txtngVL.setBackground(new java.awt.Color(173, 216, 230));
        txtngVL.setForeground(new java.awt.Color(37, 161, 142));
        txtngVL.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtngVL.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        titleKH.setBackground(new java.awt.Color(173, 216, 230));
        titleKH.setFont(new java.awt.Font("Segoe UI", 0, 22)); // NOI18N
        titleKH.setForeground(new java.awt.Color(37, 161, 142));
        titleKH.setText("Thông tin NHÂN VIÊN");

        lbtenNV.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lbtenNV.setForeground(new java.awt.Color(37, 161, 142));
        lbtenNV.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbtenNV.setText("Tên Nhân Viên");

        txttenNV.setForeground(new java.awt.Color(37, 161, 142));
        txttenNV.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbngVL.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbCvu.setForeground(new java.awt.Color(37, 161, 142));
        lbCvu.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbCvu.setText("Chức vụ");

        txtCvu.setEditable(false);
        txtCvu.setBackground(new java.awt.Color(173, 216, 230));
        txtCvu.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbNQL.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtMaNQL.setBackground(new java.awt.Color(173, 216, 230));
        txtMaNQL.setForeground(new java.awt.Color(37, 161, 142));
        txtMaNQL.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtMaNQL.setFont(new java.awt.Font("sansserif", 0, 16)); // NOI18N

        titleND.setBackground(new java.awt.Color(173, 216, 230));
        titleND.setFont(new java.awt.Font("Segoe UI", 0, 22)); // NOI18N
        titleND.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbEmail.setForeground(new java.awt.Color(37, 161, 142));
        lbEmail.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbEmail.setText("Email");

        txtemail.setEditable(false);
        txtemail.setBackground(new java.awt.Color(173, 216, 230));
        txtemail.setForeground(new java.awt.Color(37, 161, 142));
        txtemail.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtemail.setFont(new java.awt.Font("sansserif", 0, 16)); // NOI18N

        lbmk.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lbmk.setForeground(new java.awt.Color(37, 161, 142));
        lbmk.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbmk.setText("Mật Khẩu");

        txtmatkhau.setEditable(false);
        txtmatkhau.setForeground(new java.awt.Color(37, 161, 142));
        txtmatkhau.setBackground(new java.awt.Color(173, 216, 230));
        ...
        cmdDMK.setBackground(new java.awt.Color(173, 216, 230));
        cmdDMK.setBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
        cmdDMK.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbRole.setForeground(new java.awt.Color(37, 161, 142));
        lbRole.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbRole.setText("Vai trò");

        txtrole.setEditable(false);
        txtrole.setBackground(new java.awt.Color(173, 216, 230));
        txtrole.setForeground(new java.awt.Color(37, 161, 142));
        txtrole.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtrole.setFont(new java.awt.Font("sansserif", 0, 16)); // NOI18N

        txtSDT.setForeground(new java.awt.Color(37, 161, 142));
        txtSDT.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbSDT.setForeground(new java.awt.Color(37, 161, 142));
        lbSDT.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbSDT.setText("Số Điện Thoại");

        txtmaNV.setEditable(false);
        txtmaNV.setBackground(new java.awt.Color(173, 216, 230));
        txtmaNV.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.PanelRound bg;
    private Eternel_restaurants.View.Swing.Button cmdDMK;
    ...
    private Eternel_restaurants.View.Swing.ImageAvatar pic;
    private javax.swing.JLabel titleKH;
    private javax.swing.JLabel titleND;
    private Eternel_restaurants.View.Swing.MyTextField txtCvu;
    private Eternel_restaurants.View.Swing.MyTextField txtMaNQL;
    private Eternel_restaurants.View.Swing.MyTextField txtSDT;
    private Eternel_restaurants.View.Swing.MyTextField txtemail;
    private Eternel_restaurants.View.Swing.MyTextField txtmaNV;
    private Eternel_restaurants.View.Swing.MyPasswordField txtmatkhau;
    private Eternel_restaurants.View.Swing.MyTextField txtngVL;
    private Eternel_restaurants.View.Swing.MyTextField txtrole;
    private Eternel_restaurants.View.Swing.MyTextField txttenNV;
