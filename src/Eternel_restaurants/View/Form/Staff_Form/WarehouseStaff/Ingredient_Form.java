...
import Eternel_restaurants.View.Dialog.MS_Confirm;
import Eternel_restaurants.View.Form.MainForm;
import Eternel_restaurants.View.Main_Frame.Main_WarehouseStaff_Frame;
...
public class Ingredient_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        // Áp dụng custom renderer cho bảng
        TableCellRenderer renderer = new CustomTableCellRenderer();
        tableNL.setDefaultRenderer(Object.class, renderer);
    }
    ...
    private void initComponents() {
        ...
        txtTong = new Eternel_restaurants.View.Swing.MyTextField();
        lbNL = new javax.swing.JLabel();
        jSeparator2 = new javax.swing.JSeparator();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableNL = new Eternel_restaurants.View.Swing.Table();
        cmdAdd = new Eternel_restaurants.View.Swing.Button();
        cmdUpdate = new Eternel_restaurants.View.Swing.Button();
        cmdDelete = new Eternel_restaurants.View.Swing.Button();
        ...
        cmdAdd.setBackground(new java.awt.Color(39, 174, 96));
        ...
        cmdUpdate.setBackground(new java.awt.Color(241, 196, 15));
        cmdUpdate.setForeground(new java.awt.Color(255, 255, 255));
        cmdUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/edit.png"))); // NOI18N
        ...
        cmdDelete.setBackground(new java.awt.Color(231, 76, 60));
    ...
    private void txtSearchMouseEntered(java.awt.event.MouseEvent evt) {
        searchTable(txtSearch.getText().trim());
    }

    private Eternel_restaurants.View.Swing.Button cmdAdd;
    private Eternel_restaurants.View.Swing.Button cmdDelete;
    private Eternel_restaurants.View.Swing.Button cmdUpdate;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JSeparator jSeparator2;
    private javax.swing.JLabel lbNL;
    private javax.swing.JLabel lbTitle;
    private javax.swing.JLabel lbTong;
    private Eternel_restaurants.View.Swing.Table tableNL;
    private Eternel_restaurants.View.Swing.MyTextField txtSearch;
    private Eternel_restaurants.View.Swing.MyTextField txtTong;
}
