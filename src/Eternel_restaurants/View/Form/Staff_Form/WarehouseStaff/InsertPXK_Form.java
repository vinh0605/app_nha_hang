...
public class InsertPXK_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        tableCTNK.setDefaultRenderer(Object.class, new CustomTableCellRenderer());
    ...
    private void initComponents() {
        ...
        tableCTNK = new Eternel_restaurants.View.Swing.Table();
        lbDate = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        lbmaXK = new javax.swing.JLabel();
        txtmaXK = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        lbCTNK.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbDate.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbmaXK.setForeground(new java.awt.Color(37, 161, 142));
        lbmaXK.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbmaXK.setText("Mã Xuất Kho");

        txtmaXK.setEditable(false);
        txtmaXK.setBackground(new java.awt.Color(173, 216, 230));
        txtmaXK.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbNXK.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtNXK.setBackground(new java.awt.Color(173, 216, 230));
        txtNXK.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(108, 91, 123), 2, true));
        txtNXK.setForeground(new java.awt.Color(37, 161, 142));
        txtNXK.setDateFormatString("dd-MM-YYYY");
        txtNXK.setFocusable(false);
        txtNXK.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/invoice1.png"))); // NOI18N
    ...
    private Eternel_restaurants.View.Swing.Table tableCTNK;
    ...
    private Eternel_restaurants.View.Swing.MyTextField txtmaXK;
