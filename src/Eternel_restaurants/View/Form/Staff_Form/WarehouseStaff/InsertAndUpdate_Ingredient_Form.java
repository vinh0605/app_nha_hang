...
import Eternel_restaurants.Model.ModelNguyenLieu;
...
public class InsertAndUpdate_Ingredient_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txttenNL = new Eternel_restaurants.View.Swing.MyTextField();
        lbdongia = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        jSeparator2 = new javax.swing.JSeparator();
        lbDVT = new javax.swing.JLabel();
        txtmaNL = new Eternel_restaurants.View.Swing.MyTextField();
        txtdongia = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        lbmaNL.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbtenNL.setForeground(new java.awt.Color(37, 161, 142));
        lbtenNL.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbtenNL.setText("Tên Nguyên Liệu");

        txttenNL.setForeground(new java.awt.Color(37, 161, 142));
        txttenNL.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbDVT.setForeground(new java.awt.Color(37, 161, 142));
        lbDVT.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbDVT.setText("Đơn Vị Tính");

        txtmaNL.setEditable(false);
        txtmaNL.setBackground(new java.awt.Color(173, 216, 230));
        txtmaNL.setForeground(new java.awt.Color(37, 161, 142));
        txtmaNL.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtmaNL.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        txtdongia.setForeground(new java.awt.Color(37, 161, 142));
        txtdongia.setBackground(new java.awt.Color(173, 216, 230));
        ...
        jComboBoxDVT.setBackground(new java.awt.Color(173, 216, 230));
        jComboBoxDVT.setFont(new java.awt.Font("SansSerif", 0, 16)); // NOI18N
        jComboBoxDVT.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.MyTextField txtdongia;
    private Eternel_restaurants.View.Swing.MyTextField txtmaNL;
    private Eternel_restaurants.View.Swing.MyTextField txttenNL;
