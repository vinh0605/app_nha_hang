...
import Eternel_restaurants.Model.ModelPNK;
...
public class InsertPNK_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtmaNK = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        lbmaNK.setForeground(new java.awt.Color(37, 161, 142));
        lbmaNK.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbmaNK.setText("Mã Nhập Kho");

        txtmaNK.setEditable(false);
        txtmaNK.setBackground(new java.awt.Color(173, 216, 230));
        txtmaNK.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbNNK.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.MyTextField txtmaNK;
