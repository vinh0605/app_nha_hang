...
public class OrderFood_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txtTableID = new Eternel_restaurants.View.Swing.MyTextField();
        cmdBack = new javax.swing.JLabel();
        TypeMenu = new javax.swing.JComboBox<>();
        lbKH = new javax.swing.JLabel();
        txtKH = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        lbMenu.setForeground(new java.awt.Color(37, 161, 142));
        ...
        TypeMenu.setForeground(new java.awt.Color(173, 216, 230));
        TypeMenu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vietnam","China","Thailand","Japan","France","Korea","India","Malaysia","Germany","Italy","Australia","Netherlands" }));
    ...
    private Eternel_restaurants.View.Swing.MyTextField txtKH;
    private Eternel_restaurants.View.Swing.MyTextField txtSearch;
    private Eternel_restaurants.View.Swing.MyTextField txtTableID;
