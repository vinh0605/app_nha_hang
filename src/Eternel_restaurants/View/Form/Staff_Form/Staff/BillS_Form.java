package Eternel_restaurants.View.Form.Staff_Form.Staff;

import Eternel_restaurants.Controller.Service.ServiceCustomer;
import Eternel_restaurants.Controller.Service.ServiceStaff;
import Eternel_restaurants.Model.ModelBan;
import Eternel_restaurants.Model.ModelCTHD;
...
import Eternel_restaurants.View.Dialog.MS_PaymentSuccess;
import Eternel_restaurants.View.Dialog.MS_Success;
import Eternel_restaurants.View.Form.MainForm;
import Eternel_restaurants.View.Main_Frame.Main_Admin_Frame;
...
public class BillS_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdOK = new Eternel_restaurants.View.Swing.ButtonOutLine();
        cmdCancel = new Eternel_restaurants.View.Swing.ButtonOutLine();
        lbNgHD = new javax.swing.JLabel();
        txtidHD = new Eternel_restaurants.View.Swing.MyTextField();
        lbidHD = new javax.swing.JLabel();
        jSeparator3 = new javax.swing.JSeparator();
        cmdExportBill = new Eternel_restaurants.View.Swing.Button();
        jScrollPane1 = new javax.swing.JScrollPane();
        tableCTHD = new Eternel_restaurants.View.Swing.Table();
        lbTienmonan = new javax.swing.JLabel();
        txtTienmonan = new Eternel_restaurants.View.Swing.MyTextField();
        lbTiengiam = new javax.swing.JLabel();
        txtTiengiam = new Eternel_restaurants.View.Swing.MyTextField();
        lbTongtien = new javax.swing.JLabel();
        txtTongtien = new Eternel_restaurants.View.Swing.MyTextField();
        lbTienKH = new javax.swing.JLabel();
        txtTienKH = new Eternel_restaurants.View.Swing.MyTextField();
        lbTientra = new javax.swing.JLabel();
        txtTientra = new Eternel_restaurants.View.Swing.MyTextField();
        lbidKH = new javax.swing.JLabel();
        txtidKH = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        lbTitle.setForeground(new java.awt.Color(37, 161, 142));
        ...
        cmdOK.setBackground(new java.awt.Color(173, 216, 230));
        cmdOK.setForeground(new java.awt.Color(37, 161, 142));
        ...
        cmdCancel.setBackground(new java.awt.Color(173, 216, 230));
        cmdCancel.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbNgHD.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbidHD.setForeground(new java.awt.Color(37, 161, 142));
        lbidHD.setText("Mã Hóa Đơn");

        jSeparator3.setBackground(new java.awt.Color(76, 76, 76));
        jSeparator3.setOrientation(javax.swing.SwingConstants.VERTICAL);

        cmdExportBill.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbTienmonan.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtTienmonan.setForeground(new java.awt.Color(37, 161, 142));
        txtTienmonan.setBackground(new java.awt.Color(173, 216, 230));
        txtTienmonan.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtTienmonan.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        lbTiengiam.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lbTiengiam.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtTiengiam.setForeground(new java.awt.Color(37, 161, 142));
        txtTiengiam.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbTongtien.setForeground(new java.awt.Color(37, 161, 142));
        lbTongtien.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbTongtien.setText("Tổng tiền");

        txtTongtien.setEditable(false);
        txtTongtien.setForeground(new java.awt.Color(37, 161, 142));
        txtTongtien.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbTienKH.setForeground(new java.awt.Color(37, 161, 142));
        lbTienKH.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbTienKH.setText("Tiền khách đưa ");

        txtTienKH.setForeground(new java.awt.Color(37, 161, 142));
        txtTienKH.setBackground(new java.awt.Color(173, 216, 230));
        txtTienKH.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtTienKH.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        lbTientra.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtTientra.setForeground(new java.awt.Color(37, 161, 142));
        txtTientra.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbidKH.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.ButtonOutLine cmdCancel;
    private Eternel_restaurants.View.Swing.Button cmdExportBill;
    private Eternel_restaurants.View.Swing.ButtonOutLine cmdOK;
    ...
    private Eternel_restaurants.View.Swing.Table tableCTHD;
    private Eternel_restaurants.View.Swing.MyTextField txtTienKH;
    private Eternel_restaurants.View.Swing.MyTextField txtTiengiam;
    private Eternel_restaurants.View.Swing.MyTextField txtTienmonan;
    private Eternel_restaurants.View.Swing.MyTextField txtTientra;
    private Eternel_restaurants.View.Swing.MyTextField txtTongtien;
    private Eternel_restaurants.View.Swing.MyTextField txtidHD;
    private Eternel_restaurants.View.Swing.MyTextField txtidKH;
