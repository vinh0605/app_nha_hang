...
public class StaffManagement_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        tableNV.setDefaultRenderer(Object.class, new CustomTableCellRenderer());
        getInfoNQL();
        //Thêm data cho Menu
        initTable();
        getNumberofS();
    ...
    private void initComponents() {
        ...
        tableNV = new Eternel_restaurants.View.Swing.Table();
        ...
        cmdAdd.setBackground(new java.awt.Color(173, 216, 230));
        ...
        cmdUpdate.setBackground(new java.awt.Color(32, 87, 140));
    ...
    private Eternel_restaurants.View.Swing.Table tableNV;
