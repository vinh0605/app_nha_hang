package Eternel_restaurants.View.Form.Staff_Form.Admin;

import Eternel_restaurants.Controller.Service.ServiceAdmin;
import Eternel_restaurants.Model.ModelNguoiDung;
import Eternel_restaurants.Model.ModelNhanVien;
import Eternel_restaurants.View.Dialog.MS_Admin_Confirm;
...
public class InsertAndUpdate_Staff_Form extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txttSDT = new Eternel_restaurants.View.Swing.MyTextField();
        lbmaNQL = new javax.swing.JLabel();
        txtmaNQL = new Eternel_restaurants.View.Swing.MyTextField();
        cmdKick = new Eternel_restaurants.View.Swing.Button();

        setBackground(new java.awt.Color(222, 222, 222));

        bg.setBackground(new java.awt.Color(255, 255, 255));

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/karina1.png"))); // NOI18N
        ...
        lbTitle.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbNVL.setForeground(new java.awt.Color(37, 161, 142));
        ...
        cbboxCvu.setBackground(new java.awt.Color(173, 216, 230));
        cbboxCvu.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        cbboxCvu.setForeground(new java.awt.Color(37, 161, 142));
        ...
        txtNVL.setBackground(new java.awt.Color(173, 216, 230));
        txtNVL.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(173, 216, 230), 2, true));
        txtNVL.setForeground(new java.awt.Color(37, 161, 142));
        txtNVL.setDateFormatString("dd-MM-YYYY");
        txtNVL.setFocusable(false);
        txtNVL.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        txttSDT.setForeground(new java.awt.Color(37, 161, 142));
        txttSDT.setBackground(new java.awt.Color(173, 216, 230));
        txttSDT.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txttSDT.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        ...
        lbmaNQL.setForeground(new java.awt.Color(37, 161, 142));
        ...
        cmdKick.setBackground(new java.awt.Color(173, 216, 230));
        cmdKick.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.Button cmdKick;
    ...
    private Eternel_restaurants.View.Swing.MyTextField txttSDT;
