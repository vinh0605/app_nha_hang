...
public class InsertAndUpdate_Food_Form extends javax.swing.JPanel {
    ...
    public void init() {
        ...
        if (data == null) {
            ...
            pic.setIcon(new ImageIcon(getClass().getResource("/Icons/Food/Unknown/unknown.png")));
            data = new ModelMonAn();
            initID();
    ...
    private void initComponents() {
        ...
        txttenMA = new Eternel_restaurants.View.Swing.MyTextField();
        jSeparator1 = new javax.swing.JSeparator();
        jSeparator2 = new javax.swing.JSeparator();
        lbloai = new javax.swing.JLabel();
        txtmaMA = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        txtgia = new Eternel_restaurants.View.Swing.MyTextField();
        cmdStop = new Eternel_restaurants.View.Swing.Button();

        setBackground(new java.awt.Color(222, 222, 222));

        bg.setBackground(new java.awt.Color(255, 255, 255));

        pic.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Food/Unknown/unknown.png"))); // NOI18N

        lbmaMA.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lbmaMA.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbtenMA.setForeground(new java.awt.Color(37, 161, 142));
        lbtenMA.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbtenMA.setText("Tên Món Ăn");

        txttenMA.setForeground(new java.awt.Color(37, 161, 142));
        txttenMA.setBackground(new java.awt.Color(173, 216, 230));
        ...
        lbloai.setForeground(new java.awt.Color(37, 161, 142));
        lbloai.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbloai.setText("Loại Món");

        txtmaMA.setEditable(false);
        txtmaMA.setBackground(new java.awt.Color(173, 216, 230));
        txtmaMA.setForeground(new java.awt.Color(37, 161, 142));
        txtmaMA.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtmaMA.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N

        cbboxLoai.setBackground(new java.awt.Color(173, 216, 230));
        cbboxLoai.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        cbboxLoai.setForeground(new java.awt.Color(37, 161, 142));
        cbboxLoai.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Vietnam", "China", "Thailand", "Japan","France","Korea","India","Malaysia","Germany","Italy","Australia","Netherlands" }));
        cbboxLoai.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(173, 216, 230), 2));
        ...
        lbDonGia.setForeground(new java.awt.Color(37, 161, 142));
        lbDonGia.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lbDonGia.setText("Đơn Giá");

        txtgia.setForeground(new java.awt.Color(37, 161, 142));
        txtgia.setBackground(new java.awt.Color(173, 216, 230));
        ...
        cmdStop.setBackground(new java.awt.Color(173, 216, 230));
        cmdStop.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.Button cmdStop;
    ...
    private Eternel_restaurants.View.Swing.MyTextField txtgia;
    private Eternel_restaurants.View.Swing.MyTextField txtmaMA;
    private Eternel_restaurants.View.Swing.MyTextField txttenMA;
