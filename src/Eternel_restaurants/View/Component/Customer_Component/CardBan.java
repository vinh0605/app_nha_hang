...
public class CardBan extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdBook = new Eternel_restaurants.View.Swing.Button();
        lbTitle = new javax.swing.JLabel();

        panelRound1.setPreferredSize(new java.awt.Dimension(300, 300));

        img.setBackground(new java.awt.Color(173, 216, 230));
        ...
        cmdBook.setBackground(new java.awt.Color(173, 216, 230));
        cmdBook.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.Button cmdBook;
