...
import Eternel_restaurants.View.Dialog.MS_ConfirmOrderFood;
...
public class CardMonAn extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMinus = new Eternel_restaurants.View.Swing.ButtonOutLine();
        cmdAdd = new Eternel_restaurants.View.Swing.ButtonOutLine();
        cmdOrder = new Eternel_restaurants.View.Swing.Button();
        txtNum = new Eternel_restaurants.View.Swing.MyTextField();
        ...
        cmdOrder.setBackground(new java.awt.Color(173, 216, 230));
        cmdOrder.setForeground(new java.awt.Color(37, 161, 142));
        cmdOrder.setText("THÊM");
        cmdOrder.setToolTipText("");
        cmdOrder.setFocusable(false);
        cmdOrder.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
    ...
    private Eternel_restaurants.View.Swing.ButtonOutLine cmdAdd;
    private Eternel_restaurants.View.Swing.ButtonOutLine cmdMinus;
    private Eternel_restaurants.View.Swing.Button cmdOrder;
    private javax.swing.JLabel img;
    private javax.swing.JLabel lbTitle;
    private javax.swing.JLabel lbValue;
    private Eternel_restaurants.View.Swing.MyTextField txtNum;
