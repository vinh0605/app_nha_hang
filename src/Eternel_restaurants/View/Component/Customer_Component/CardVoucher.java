...
import Eternel_restaurants.Model.ModelVoucher;
import Eternel_restaurants.View.Dialog.MS_ConfirmExchangeVoucher;
...
public class CardVoucher extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdExchange = new Eternel_restaurants.View.Swing.Button();
        ...
        lbQuantity.setForeground(new java.awt.Color(37, 161, 142));
        lbQuantity.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbQuantity.setText("Quantity");

        cmdExchange.setBackground(new java.awt.Color(173, 216, 230));
        cmdExchange.setForeground(new java.awt.Color(37, 161, 142));
        cmdExchange.setText("ĐỔI VOUCHER");
        cmdExchange.setToolTipText("");
        cmdExchange.setFocusable(false);
        cmdExchange.setFont(new java.awt.Font("Sogoe UI", 1, 14)); // NOI18N

        ibDescription.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ibDescription.setForeground(new java.awt.Color(37, 161, 142));
        ...
        lbPoint.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.Button cmdExchange;
