package Eternel_restaurants.View.Component.Staff_Component;
...
import Eternel_restaurants.View.Dialog.MS_CancelReserve;
import Eternel_restaurants.View.Dialog.MS_ConfirmReserve;
import Eternel_restaurants.View.Form.MainForm;
import Eternel_restaurants.View.Form.Staff_Form.Staff.OrderFood_Form;
...
public class CardBanS extends javax.swing.JPanel {
    ...
    public void init(){
        ...
        switch (table.getStatus()) {
            ...
            case "Dang dung bua" -> {
                img.setBackground(Color.decode("#20578C"));
    ...
    private void initComponents() {
        ...
        panelRound1 = new Eternel_restaurants.View.Swing.PanelRound();
        img = new javax.swing.JLabel();
        lbValue = new javax.swing.JLabel();
        cmdAdj = new Eternel_restaurants.View.Swing.Button();
        lbTitle = new javax.swing.JLabel();

        panelRound1.setPreferredSize(new java.awt.Dimension(300, 300));

        img.setBackground(new java.awt.Color(233, 228, 240));
        img.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/table_nh.png"))); // NOI18N
        img.setOpaque(true);

        lbValue.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        lbValue.setForeground(new java.awt.Color(37, 161, 142));
        lbValue.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbValue.setText("Value");

        cmdAdj.setBackground(new java.awt.Color(173, 216, 230));
        cmdAdj.setForeground(new java.awt.Color(37, 161, 142));
    ...
    private Eternel_restaurants.View.Swing.Button cmdAdj;
    private javax.swing.JLabel img;
    private javax.swing.JLabel lbTitle;
    private javax.swing.JLabel lbValue;
    private Eternel_restaurants.View.Swing.PanelRound panelRound1;
