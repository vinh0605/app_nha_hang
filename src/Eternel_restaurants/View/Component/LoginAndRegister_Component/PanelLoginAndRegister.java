...
import Eternel_restaurants.View.Swing.Button;
import Eternel_restaurants.View.Swing.MyPasswordField;
import Eternel_restaurants.View.Swing.MyTextField;
...
public class PanelLoginAndRegister extends javax.swing.JLayeredPane {
    ...
    private void initRegister(ActionListener eventRegister) {
        ...
        label.setForeground(Color.decode("#4B5C7E"));
        register.add(label);
        ...
        cmd.setBackground(Color.decode("#4B5C7E"));
