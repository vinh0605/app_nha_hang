...
import Eternel_restaurants.View.Swing.ButtonOutLine;
import Eternel_restaurants.View.Swing.ImageLogo;
    ...
    private void login(boolean login){
        if(this.isLogin!=login){
            ...
            if(login){
                ...
                description.setText("Đừng lo lắng, hãy bắt đầu tạo mới một tài khoản");
                description1.setText("và sử dụng dịch vụ của chúng tôi");
                ...
                description.setText("Để sử dụng dịch vụ");
                description1.setText("vui lòng đăng nhập với tài khoản cá nhân của bạn");
                button.setText("<<  Đăng nhập");
            }
            this.isLogin=login;
        }
