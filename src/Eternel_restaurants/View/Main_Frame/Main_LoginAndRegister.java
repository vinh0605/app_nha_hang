...
import Eternel_restaurants.Model.ModelLogin;
import Eternel_restaurants.Model.ModelNguoiDung;
import Eternel_restaurants.View.Component.LoginAndRegister_Component.Message;
import Eternel_restaurants.View.Component.LoginAndRegister_Component.PanelCover;
import Eternel_restaurants.View.Component.LoginAndRegister_Component.PanelLoading;
import Eternel_restaurants.View.Component.LoginAndRegister_Component.PanelLoginAndRegister;
import Eternel_restaurants.View.Component.LoginAndRegister_Component.PanelVerifyCode;
    ...
    private void register() {
        ...
        try {
            if (service.checkDuplicateEmail(user.getEmail())) {
                ...
                // Bỏ qua xác minh email và trực tiếp đánh dấu người dùng là đã xác minh
                service.doneVerify(user.getUserID(), loginAndRegister.getName());
                showMessage(Message.MessageType.SUCCESS, "Đăng ký thành công");
            }
        } catch (SQLException e) {
            e.printStackTrace();
